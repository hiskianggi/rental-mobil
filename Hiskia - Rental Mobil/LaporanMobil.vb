...
Public Class LaporanMobil
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hiskia___Rental_Mobil.LaporanMobil.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanMobil
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanMobil = New LaporanMobil()
        rpt.Site = Me.Site
        Return rpt
    End Function

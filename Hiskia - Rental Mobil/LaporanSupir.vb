...
Public Class LaporanSupir
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hiskia___Rental_Mobil.LaporanSupir.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanSupir
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanSupir = New LaporanSupir()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class LaporanPetugas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hiskia___Rental_Mobil.LaporanPetugas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanPetugas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanPetugas = New LaporanPetugas()
        rpt.Site = Me.Site
        Return rpt
    End Function
